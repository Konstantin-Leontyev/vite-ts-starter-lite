 ...
 * по высоте и анимирует её. Развёрнутый слот равен HEADER_BLOCK_SIZE, свёрнутый — COLLAPSED_INSET
 * (остаётся тонкая полоса фона как верхний отступ страницы). Сама полоса уезжает вверх за границу
 * слота (translateY), поэтому кнопки скрыты и не перекрывают контент. Уменьшение высоты сдвигает
 * вторую строку каркаса и сжимает рабочую область.
 */
